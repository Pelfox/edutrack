        ...
        "schemas": {
            ...
            "dto.AnalyticsOverview": {
                "properties": {
                    ...
                    "grade_distribution": {
                        "items": {
                            "$ref": "#/components/schemas/dto.AnalyticsGradeDistribution"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
                    ...
                    "subject_averages": {
                        "items": {
                            "$ref": "#/components/schemas/dto.AnalyticsSubjectAverage"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/dto.CreateProfile",
                                        "summary": "request",
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/dto.UpdateProfile",
                                        "summary": "request",
                                        "description": "Данные профиля"
                                    }
                                ]
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/dto.AnalyticsOverview"
                                }
                            }
                        },
                        "description": "OK"
